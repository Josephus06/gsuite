      ...
      <div className="card" style={{ marginBottom: 16 }}>
        <div className="filter-grid">
          <div className="field">
            ...
            <input value={search} onChange={(e) => setSearch(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && runSearch()} placeholder="IR No., IF No. or TO No..." />
          </div>
          <div className="field">
        ...
        {!loading && (
          <>
            <div className="muted" style={{ marginTop: 12 }}>
              {total.toLocaleString()} item receipt{total === 1 ? '' : 's'}
            </div>
