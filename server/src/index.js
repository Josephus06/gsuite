...
const hrIncidentReportRoutes = require('./routes/hrIncidentReports');
...
app.use('/api/hr-violations', hrViolationRoutes);
app.use('/api/hr-incident-reports', hrIncidentReportRoutes);
